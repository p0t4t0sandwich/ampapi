 ...
 */
public record BackupManifest(Boolean CreatedAutomatically, String Description, String HashSHA1, UUID Id, String META, String ModuleName, String Name, String RemoteStoreId, SupportedOS SourceOS, Boolean Sticky, Boolean StoredLocally, Boolean StoredRemotely, String TakenBy, String Timestamp, Integer TotalSizeBytes, Optional<UUID> ParentManifest) {}
